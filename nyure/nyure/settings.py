"""
Django settings for nyure project.
...
WSGI_APPLICATION = 'nyure.wsgi.application'
...
# Add corsheaders middleware (add it at the beginning of the MIDDLEWARE list)
MIDDLEWARE = [
